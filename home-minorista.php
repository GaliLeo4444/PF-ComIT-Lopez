...
<html>
    ...
    <?php
            ...
            $sql = "SELECT id_mayor, fecha, estado FROM pedido WHERE id_minor=" . $minorista;
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="home-minorista.php">Mi Cuenta <span class="caret"></span></a>
